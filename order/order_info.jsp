...
<div class="form-group row">
	...
	<div class="col-sm-3">
    <input name="shippingDate" type="date" class="form-control" id="shippingDateInput" />(yyyy/mm/dd)
	</div>
	  </div>
	 <div class="form-group row">
	   <label class="col-sm-2">국가명</label>
	     <div class="col-sm-sel">
    ...
    <input type="text" name = "detailName" id="sample4_detailAddress" placeholder="상세주소">
