...
<%
	...
	if (cookies != null) {
		for (int i = 0; i < cookies.length; i++) { // 길이만큼 쿠키 읽기
            ...
            if (n.equals("Shipping_detailName"))
				shipping_detailName = URLDecoder.decode((thisCookie.getValue()), "utf-8");
		}
	}
%>
<html>
...
<body>
	...
	<div class="row justify-content-between">
		<div class="col-4" align="left">
            ...
            상세주소:  <% out.println(shipping_detailName);%><br>
		</div>
